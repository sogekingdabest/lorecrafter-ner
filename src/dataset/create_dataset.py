...
FANTASY_ENTITIES = {
    ...
    "FACCION": [
        ...
        "los Teleri",
        "los Vanyar",
        "la Hermandad del Lobulo Rojo",
        "los Jinetes de Rohan",
        "los Escudos de Gondor",
    ],
}
...
SENTENCE_TEMPLATES = [
    ...
    "Las cronicas de {LUGAR} narran como {PERSONAJE} destruyo {ARTEFACTO_MAGICO} traicionado por {RAZA}.",  # noqa: E501
...
COMPLEX_SENTENCES = [
    "Tras días de marcha, {PERSONAJE} y su compañia de {RAZA} llegaron a las puertas de {LUGAR}, donde {FACCION} los esperaba con {ARTEFACTO_MAGICO} en mano.",  # noqa: E501
    "Las leyendas de {LUGAR} cuentan que {PERSONAJE}, el más sabio de los {RAZA}, escondió {ARTEFACTO_MAGICO} para que {FACCION} nunca lo encontrara.",  # noqa: E501
    "Cuando {PERSONAJE} alzó {ARTEFACTO_MAGICO} sobre las murallas de {LUGAR}, los {RAZA} de {FACCION} prorrumpieron en vítores de guerra.",  # noqa: E501
    "El consejo de {FACCION} se reunió en {LUGAR} para decidir el destino de {ARTEFACTO_MAGICO}, con {PERSONAJE} como único {RAZA} en votar en contra.",  # noqa: E501
    "{PERSONAJE} juró ante {ARTEFACTO_MAGICO} que defendería {LUGAR} hasta el último aliento, cumpliendo la promesa hecha a {FACCION} hace eras.",  # noqa: E501
]
...
EXTRA_TEMPLATES = [
    ...
    "El {RAZA} {PERSONAJE} fue exiliado de {LUGAR} y se unio a {FACCION} portando {ARTEFACTO_MAGICO}.",  # noqa: E501
    "En {LUGAR}, los {RAZA} de {FACCION} celebraron la victoria de {PERSONAJE} con {ARTEFACTO_MAGICO}.",  # noqa: E501
]
...
def generate_synthetic_texts(count=500):
    ...
    for _ in range(count):
        ...
        for label in ["PERSONAJE", "LUGAR", "RAZA", "ARTEFACTO_MAGICO", "FACCION"]:
            if "{" + label + "}" in text:
                text = text.replace(
                    "{" + label + "}", random.choice(FANTASY_ENTITIES[label]), 1
                )
        texts.append(text)
